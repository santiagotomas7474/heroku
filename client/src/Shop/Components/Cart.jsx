...
function Cart(){
    ...
    <Typography gutterBottom variant="h5" component="div" align="left" sx={{ mt: 4, ml: 3 }}>Lista de productos: </Typography> 
    ...
    <Grid container spacing={1.5}>
      ...
      <Typography gutterBottom variant="h5" component="div" align="right" sx={{ mt: 1, mr: 3 }} > El precio total es:  $ {total},00 </Typography>
      </Container>
